...
namespace Components
{
    struct Transform : public Component
    {
        ...
        Transform(Game::Entity* entity, Vector2 position, float scale) : Transform(entity, position, scale, 0) {}
        Transform(Game::Entity* entity, float scale) : Transform(entity, Vector2(0, 0), scale, 0) {}
